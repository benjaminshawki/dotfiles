...
public class BattleShip extends Unit implements ShipUnit {
  ...
  @Setter @Getter public ResearchType researchRequired = ResearchType.BattleShip;
  @Setter @Getter private long baseSecondsToProduce = 10;
  @Setter @Getter private UnitType unitName = UnitType.BattleShip;
  @Setter @Getter private int attack = 50;
  @Setter @Getter private int defence = 0;
  @Setter @Getter private int health = 10;
  @Setter @Getter private int speed = 50;
  @Setter @Getter private int plunderAmount = 500;
