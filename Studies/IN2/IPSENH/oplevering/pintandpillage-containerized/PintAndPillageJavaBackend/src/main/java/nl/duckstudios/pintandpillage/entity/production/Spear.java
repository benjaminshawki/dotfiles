...
public class Spear extends Unit {
  ...
  @Setter @Getter public ResearchType researchRequired = ResearchType.Spear;
  @Setter @Getter private long baseSecondsToProduce = 10;
  @Setter @Getter private UnitType unitName = UnitType.Spear;
  ...
  @Setter @Getter private String description = "War hardened vikings wielding a spear";
