...
local jdtls_path = vim.fn.stdpath('data') .. "$HOME/.config/local/share/nvim/mason/packages/jdtls"
...
local path_to_java_dap = "$HOME/java/java-debug-0.52.0/com.microsoft.java.debug.plugin/target/"
...
local config = {
  ...
  init_options = {
    bundles = {
      vim.fn.glob(path_to_java_dap .. "com.microsoft.java.debug.java-debug-0.52.0.jar", 1)
    },
  },
}
