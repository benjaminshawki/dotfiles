...
local workspace_path = home .. '/.config/local/share/nvim/jdtls-workspace/'
...
local config = {
  cmd = {
    ...
    '-jar',
    vim.fn.glob(home .. '/.config/local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar'),
    '-configuration',
    home .. '/.config/local/share/nvim/packages/jdtls/config_linux',
    '-data',
    workspace_dir,
  },
